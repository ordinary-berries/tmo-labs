...
const val DYNAMIC_GROUP_AGENTS_AMOUNT_METRIC = "dynamic-group-agents-amount"
...
fun getPrioritizedTimeInSystemMetricName(): String {
    return getPrioritizedTimeInSystemMetricName(1)
}
...
fun getPrioritizedEventPersistMetricName(): String {
    return getPrioritizedEventPersistMetricName(1)
}
