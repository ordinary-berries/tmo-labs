...
private fun waitTimeToNCase() {
    ...
    nRange.map { n ->
        ...
        queueSizeAvg.add(
            metrics.getDynamic(getPrioritizedEventPersistMetricName(1), "QueuePersistence").average()
        )
    }
...
private data class L2Table(
    ...
    fun append(
        ...
        val avgQueueSize = metrics.getDynamic(getPrioritizedEventPersistMetricName(1), "QueuePersistence").average()
